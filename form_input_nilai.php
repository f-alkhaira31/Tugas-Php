...
//Fungsi If di bawah Adalah untuk melihat jurusan apa mahasiswa yang sebelumnya dipilih dan langsung otomatis menampilkan jurusannya di combobox jurusan
	...
	?>
<form method="post" action="controller/insert_nilai.php">
...
Semester 		:		<input type="radio" name="semester" value="1" /> 1		<input type="radio" name="semester" value="2" /> 2		<input type="radio" name="semester" value="3" /> 3		<input type="radio" name="semester" value="4" /> 4 
...
Matakuliah		:		<select name="makul">
	...
	include 'setting/koneksi.php';
		...
		echo "<option value = '".$bca_matkul['id_matkul']."'>".$bca_matkul['nama_matkul']."</option>";
}
?>
</select>

Nilai tugas 		:		<input type="text" name="ttugas" style="height: 30px; width: 80px;">

Nilai Quis 		:		<input type="text" name="tquis" style="height: 30px; width: 80px;">

Nilai UTS 		:		<input type="text" name="tuts" style="height: 30px; width: 80px;" >

Nilai Uas 		:		<input type="text" name="tuas" style="height: 30px; width: 80px;">
