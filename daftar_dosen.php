...
<body>
	...
	<section id="about" class="section">
		<div class="container">
			<h4>Daftar Dosen</h4>
<p><a href="form_input_data_dosen.php">Tambah Dosen</a></p>
<table border="1" cellpadding="5" width="100%">
	...
	<tbody>
		...
		include 'Model/data_seluruh_dosen.php';
		...
		<tr>
			...
			<td><a href="form_edit_data_dosen.php?id=<?php echo $dosen['id']; ?>">Edit</a> || <a href="controller/delete_dosen.php?id=<?php echo $dosen['id']; ?>">Hapus</a></td>
