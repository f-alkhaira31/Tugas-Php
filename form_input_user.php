...
<pre>
Id			:		<input type="text" name="tid" value="" required="" style="height: 30px; width: 150px;"><br>
Username 		:		<input type="text" name="tusername" required="" value="" style="height: 30px; width: 400px;"><br>
Nama			:		<input type="text" name="tnama" style="height: 30px; width: 400px;" required=""><br>
Tingkatan User 		:		<select name="tingkatan">
	<option selected="">~Tingkatan User~</option>
	<option value="Admin">Admin</option>
	<option value="Operator">Operator</option>
</select><br>
Password 		: 		<input type="Password" required="" name="pass"><br>
No Hp 			: 		<input type="text" name="no_hp" style="height: 30px; width: 400px;"><br>
</pre>
<div align="left">
