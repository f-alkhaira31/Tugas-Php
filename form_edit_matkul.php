...
<body>
	...
	<?php
		...
		include 'setting/koneksi.php';
		include 'Model/biodata_matkul.php';

		$matkul = mysqli_fetch_array($query);
	?>			
<form method="post" action="controller/edit_matkul.php">
<pre>
Id Matakuliah			:		<input type="text" name="tid" readonly="" value="<?php echo $matkul['id_matkul']; ?>" style="height: 30px; width: 150px;"><br>
Matakuliah			:		<input type="text" name="tmatkul" value="<?php echo $matkul['nama_matkul']; ?>" style="height: 30px; width: 400px;"><br>
</pre>
<div align="left">
