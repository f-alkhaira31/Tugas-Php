...
<body>
	...
	<section id="about" class="section">
		<div class="container">
			<h4>Mahasiswa POLITEKNIK LP3i Kampus K Pekanbaru</h4>
<form method="post" action="controller/insert_mahasiswa.php">
<h3 align="center"><blink>Input Data Mahasiswa</blink></h3>
<pre>
NIM			:		<input type="text" name="tnim" value="" style="height: 30px; width: 150px;"><br>
Nama Mahasiswa		:		<input type="text" name="tnama" value="" style="height: 30px; width: 400px;"><br>
Jenis Kelamin		:		<input type="radio" name="jenis_kelamin" value="L">Laki-Laki 	<input type="radio" name="jenis_kelamin" value="P">Perempuan<br><br>
...
Kelas			:		<input type="text" name="kelas" value="" style="height: 30px; width: 100px;"><br>
No Hp 			:		<input type="text" name="no_hp" style="height: 30px; width: 180px;"><br>
</pre>
<div align="left">
