...
<form method="post" action="controller/insert_dosen.php">
<h3 align="center"><blink>Input Data Dosen</blink></h3>
<pre>
Id			:		<input type="text" name="tid" value="" style="height: 30px; width: 150px;"><br>
Nama 			:		<input type="text" name="tnama" value="" style="height: 30px; width: 400px;"><br>
