...
<body>
	...
	<section id="about" class="section">
		<div class="container">
			<h4>Daftar User</h4>
<p><a href="form_input_user.php">Tambah User Baru</a></p>
<table border="1" cellpadding="5" width="100%">
	...
	<tbody>
		...
		include 'Model/data_seluruh_user.php';
		//Variabel i Untuk Memberi No Otomatis
		$i=0;
		...
		<tr>
			...
			<td><?php echo $user['tingkatan_user']; ?></td>
			<td><?php echo $user['no_hp']; ?></td>
			<td><a href="form_edit_user.php?id=<?php echo $user['id_user']; ?>">Edit</a> || <a href="controller/delete_user.php?id=<?php echo $user['id_user']; ?>">Hapus</a></td>
