...
//Fungsi If di bawah Adalah untuk melihat jurusan apa mahasiswa yang sebelumnya dipilih dan langsung otomatis menampilkan jurusannya di combobox jurusan
	...
	?>			
<form method="post" action="controller/edit_mahasiswa.php">
<h3 align="center"><blink>Input Data Mahasiswa</blink></h3>
<pre>
NIM			:		<input type="text" name="tnim" readonly="" value="<?php echo $biodata['nim']; ?>" style="height: 30px; width: 150px;"><br>
Nama Mahasiswa		:		<input type="text" name="tnama" value="<?php echo $biodata['nama']; ?>" style="height: 30px; width: 400px;"><br>
Jenis Kelamin		:		<?php echo $jnisklamin; ?><br>
Jurusan 		: 		<select name="jurusan">
	<option  selected="">Pilih Jurusan</option>
	<?php echo $pil_jurusan; ?>
</select><br>
Kelas			:		<input type="text" name="kelas" value="<?php echo $biodata['kelas']; ?>" style="height: 30px; width: 100px;"><br>
No Hp 			:		<input type="text" value="<?php echo $biodata['no_hp']; ?>" name="no_hp" style="height: 30px; width: 180px;"><br>
</pre>
<div align="left">
