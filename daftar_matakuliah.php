...
<p><a href="form_input_matkul.php">Tambah Matakuliah</a></p>
<table border="1" cellpadding="5" width="100%">
	...
	<tbody>
		...
		include 'Model/data_seluruh_matakuliah.php';
		while ($matkul=mysqli_fetch_array($query)){
		?>
		<tr>
			<td><?php echo $matkul['id_matkul']; ?></td>
			<td><?php echo $matkul['nama_matkul']; ?></td>
			<td><a href="form_edit_matkul.php?id_matkul=<?php echo $matkul['id_matkul']; ?>">Edit</a> || <a href="controller/delete_matkul.php?id=<?php echo $matkul['id_matkul']; ?>">Hapus</a></td>
