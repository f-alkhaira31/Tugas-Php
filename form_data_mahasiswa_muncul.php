...
<body>
	...
	<section id="about" class="section">
		<div class="container">
			...
			?>
<form method="post" action="form_data_mahasiswa_muncul.php">
<pre>
<p style="font-size: 20px;"><a href=""></a></p>
Pilih Kelas :	<select name="kelas">
	<option selected="">~pilih kelas~</option>
	 <?php

	 	include 'Model/baca_kelas.php';
if(empty($_POST['kelas'])) {	
	...
	$kelass=$_POST['kelas'];
	 	...
	 	while ($data_kelas=mysqli_fetch_array($query)){

	 		if($kelass == $data_kelas['kelas']){
	 			$pil = "selected"; 
	 		}else{
	 			$pil = "";
	 		}

	 		echo "<option value ='".$data_kelas['kelas']."' $pil>".$data_kelas['kelas']."</option>";
	 	}

	 ?>
</select> 		<input type="submit" name="cek" value="Cek" style="width: 100px;">
...
<table border="1" cellpadding="5" width="100%">
	...
	<tbody>
		...
		include 'Model/data_mahasiswa_perkelas.php';
		while ($Mahasiswa=mysqli_fetch_array($A)){
		...
		<tr>
			...
			<td><a href="form_input_nilai.php?nim=<?php echo $Mahasiswa['nim']; ?>">input nilai</a> || <a href="form_edit_nilai.php?nim=<?php echo $Mahasiswa['nim']; ?>">edit nilai</a></td>
